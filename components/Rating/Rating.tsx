...
export const Rating = ({ rating, setRating }: RatingProps): JSX.Element => {
		...
		return (
			<span
				...
				className={cn(styles.star, {
					...
					[styles.pointer]: setRating
				})}
				onMouseEnter={() => setRating && setRating(i + 1)}
				onMouseLeave={() => setRating && setRating(currentRating)}
				onClick={() => setRating && setCurrentRating(i + 1)}
			>
